...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :facebook, '1062834280493751', '7fd61b735c02a2b2c694330977399dfe', {:scope => 'PERMISSION_1, PERMISSION_2, PERMISSION_3...', {:client_options => {:ssl => {:ca_file => '/usr/lib/ssl/certs/ca-certificates.crt'}}}
